...
type
  ...
  protected
    ...
    function NextCell (a0 : integer; var i : integer; c: integer) : integer;
...
constructor THashTable.Create(ASize : integer);
var
  i : integer;
begin
  Clear;
...
function THashTable.NextCell(a0: integer; var i: integer; c: integer): integer;
begin
  Inc(i);
